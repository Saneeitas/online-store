        ...
        <div class="col-4">
            ...
            <div class="border p-3">
                <form action="search.php" method="post">
                    ...
                    <button type="submit" class="btn btn-sm mt-2" style="color:#FF6347;"><i class="fas fa-search"></i> SEARCH</button>

                </form>
            </div>

            <div class="border p-3">
                <h4 class="list-group-item " style="color:#FF6347;"><i class="fas fa-grip-vertical"></i> CATEGORIES</h4>
                <ul class="list-group">
    <?php
